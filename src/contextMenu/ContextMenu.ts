...
export class ContextMenuElement {
  ...
  constructor(
    ...
    this._el.addEventListener("pointerenter", (e: PointerEvent) =>
      onpointerenter(e, option, this._el, this.rootNode),
    );
