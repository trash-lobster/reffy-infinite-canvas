...
function makeHost() {
  ...
  const host: any = {
    ...
    eventHub,
    // options
    singleImageMenuOptions: createSingleImageMenuOptions.call(
      baseFns,
      createBasicImageMenuOptions.call(baseFns).options,
    ),
    multiImageMenuOptions: createMultiImageMenuOptions.call(
      baseFns,
      createBasicImageMenuOptions.call(baseFns).options,
    ),
...
describe("Interaction context menu helpers", () => {
  ...
  it("option factories produce expected structure", () => {
    ...
    const hasSub = multi.options.some((g) =>
      g.childOptions.some((o) => "subMenu" in o),
    );
...
describe("createMultiImageMenuOptions", () => {
  ...
  it("produces a group with Align submenu and calls align on click", () => {
    ...
    const left = alignGroup.childOptions.find(
      (o: any) => o.text === "Align Left",
    );
    const right = alignGroup.childOptions.find(
      (o: any) => o.text === "Align Right",
    );
    const top = alignGroup.childOptions.find(
      (o: any) => o.text === "Align Top",
    );
    const bottom = alignGroup.childOptions.find(
      (o: any) => o.text === "Align Bottom",
    );
